...
namespace vMenuClient
{
    public class About
    {
        ...
        private void CreateMenu()
        {
            ...
            MenuItem credits = new MenuItem("About vMenu / Credits", "vMenu is made by ~b~Vespura~s~. This version has been modified by ~b~dotexe~s~. For more info, checkout ~b~www.vespura.com/vmenu~s~ and ~b~www.github.com/original-dotexe/vMenu-Improved~s~. Thank you to: Quadruplex, Deltanic, Brigliar, IllusiveTea, Shayan Doust and zr0iq for your contributions.");
